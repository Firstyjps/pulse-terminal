...
| `ALERT_LOG_MAX_BYTES` | Rotate current JSONL when next write would exceed this size | `10485760` |
| `ALERT_LOG_MAX_ARCHIVES` | Number of rotated JSONL archives to keep | `5` |
